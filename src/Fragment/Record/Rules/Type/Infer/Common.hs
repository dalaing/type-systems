...
type RecordInferTypeContext e w s r (m :: * -> *) mi ki ty pt tm a = (AsTyRecord ki ty, AsExpectedTyRecord e ki ty a, AsRecordNotFound e, AsPtRecord pt, AsTmRecord ki ty pt tm, MonadError e mi)

inferTypeInput :: RecordInferTypeContext e w s r m mi ki ty pt tm a
