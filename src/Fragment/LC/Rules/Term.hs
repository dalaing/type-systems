...
stepTmLamAppLazy :: (TmAstBound ki ty pt tm, AsTmLam ki ty pt tm, AsTmApp ki ty pt tm) => Term ki ty pt tm a -> Maybe (Term ki ty pt tm a)
...
stepTmLamAppStrict :: (TmAstBound ki ty pt tm, AsTmLam ki ty pt tm, AsTmApp ki ty pt tm) => (Term ki ty pt tm a -> Maybe (Term ki ty pt tm a)) -> Term ki ty pt tm a -> Maybe (Term ki ty pt tm a)
