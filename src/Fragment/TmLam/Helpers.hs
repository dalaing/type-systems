...
tmLamAnn v ty tm = review _TmLamAnn (ty, abstract1 (review _TmAstTmVar v) . review _Unwrapped $ tm)

tmLamNoAnn :: (Eq a, AsTmLam ki ty pt tm) => a -> Term ki ty pt tm a -> Term ki ty pt tm a
tmLamNoAnn v tm = review _TmLamNoAnn (abstract1 (review _TmAstTmVar v) . review _Unwrapped $ tm)
